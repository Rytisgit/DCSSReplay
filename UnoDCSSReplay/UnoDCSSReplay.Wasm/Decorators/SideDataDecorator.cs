...
namespace InputParser.Decorators
{
    public class SideDataDecorator : AbstractDecorator
    {
        ...
        private static SideDataColored ParseColoredSideData(TerminalCharacter[,] chars)
        {
        ...
        {
            var sideData = ExtractEasySideDataValues(characters);
        ...
        private static SideData ExtractEasySideDataValues(TerminalCharacter[,] characters)
        {
